...
export default class Page {
          ...
          <div class="container">
            ...
            <div class="main__inner">
              ...
              <div class="main__bottom">
                <button class="button" type="button" data-load>Load more</button>
                <button class="main__scroll-button button" type="button" data-scroll aria-label="scroll-top">
  ...
  private addListeners = (): void => {
    ...
    (
      Page.container.querySelector('[data-theme]') as HTMLButtonElement
    ...
    (
      Page.container.querySelector('[data-load]') as HTMLButtonElement
    ).addEventListener('click', () => {
      Page.pageCount++;
      preloader.show();
      this.moviesContainer.classList.add('hide');
